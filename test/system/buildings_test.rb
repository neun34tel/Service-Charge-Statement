...
class BuildingsTest < ApplicationSystemTestCase
  ...
  test "should create building" do
    ...
    fill_in "Plot area", with: @building.plot_area
    fill_in "Total residential area", with: @building.total_residential_area
    fill_in "Total usable area", with: @building.total_usable_area
